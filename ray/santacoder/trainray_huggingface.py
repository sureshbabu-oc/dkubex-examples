...
def create_datasets(args):
    tokenizer = AutoTokenizer.from_pretrained(args.model_path, use_auth_token=True,  use_fast=True)
    ...
    valid_dataset = ray.data.from_huggingface(valid_dataset)
    return train_dataset, valid_dataset



def run_training(train_dataset, eval_dataset = None, **config):
...
def main(args):
    ...
    trainer_init_per_worker=run_training,
    ...
    run_config=RunConfig(
        ...
        failure_config=ray.air.FailureConfig(-1),
