...
class TreeModel:
    ...
    def mlflow_run(self, experiment_name="local experiments", run_name="Breast Cancer Classification Run"):
        """
        ...
        with mlflow.start_run(run_name=run_name) as run:
            ...
            mlflow.sklearn.log_model(self.model, "decision-tree-classifier", registered_model_name="LocallyTrained")
